    ...
    <el-table :data="tableTreeData" stripe size="mini" style="width: 100%;"
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <kt-button icon="fa fa-edit" :size="size" :label="$t('action.edit')" perms="sys:dept:edit" @click="handleEdit(scope.row)"/>
          <kt-button icon="fa fa-trash" :size="size" :label="$t('action.delete')" perms="sys:dept:delete" type="danger" @click="handleDelete(scope.row)"/>
        </template>
      </el-table-column>
    </el-table>
    <!-- 新增修改界面 -->
