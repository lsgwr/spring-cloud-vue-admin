  ...
  <div class="page-container">
    ...
    <div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
      <el-form :inline="true" :model="filters" :size="size">
        ...
        <el-form-item>
          <kt-button icon="fa fa-search" :label="$t('action.search')" size="small" perms="sys:menu:view" type="primary" @click="findTreeData(null)"/>
        </el-form-item>
        <el-form-item>
    ...
    <!--表格树内容栏-->
    <el-table :data="tableTreeData" stripe size="mini" style="width: 100%;" v-loading="loading" rowKey="id" element-loading-text="$t('action.loading')">
      <el-table-column
...
import PopupTreeInput from '../PopupTreeInput'
import FaIconTooltip from '../FaIconTooltip'
